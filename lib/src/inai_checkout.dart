...
class InaiCheckout {
  ...
  static Future<InaiApplePayRequest> initApplePayRequest(
    ...
    if (applePayPaymentMethod != null) {
      ...
      inaiApplePayRequest.payClient = Pay({
